...
contract ASTICO is Ownable {

  using SafeMath for uint256;

  Token public token;

  uint256 public constant RATE = 1650; // Number of tokens per Ether
  uint256 public constant CAP = 60606; // Cap in Ether
  uint256 public constant START = 1504594800; // Sep 5, 2017 @ 08:00 GMT+1
  uint256 public constant DAYS = 7; // 7 Days

  uint256 public constant initialTokens = 10000000000; // Initial number of tokens available
  ...
  function ASTICO(address _tokenAddr) {
